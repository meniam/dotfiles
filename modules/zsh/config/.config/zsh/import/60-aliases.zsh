...
alias ll='eza --tree --level=1 --long --group --icons=always --group-directories-first'
alias ll1='eza --tree --level=1 --long --group --icons=always --group-directories-first'
alias ll2='eza --tree --level=2 --long --group --icons=always --group-directories-first'
alias du='du -h'
alias df='df -h'
